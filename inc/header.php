				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><a href="<?php URL; ?>index.php">Techstore</a></div>
						</div>
					</div>
						...
						<div class="header_search">
							<div class="header_search_content">
								<div class="header_search_form_container">
									<form method="GET" action="<?php URL ?> search.php" class="header_search_form clearfix">
							...
							<div class="cart">
								<div class="cart_container d-flex flex-row align-items-center justify-content-end">
									<div class="cart_icon">
										...
										<div class="cart_count"><span><?= isset($cartCount) ? $cartCount : 0 ; ?></span></div>
									</div>
									<div class="cart_content">
										<div class="cart_text"><a href="<?php URL ?>cart.php">Cart</a></div>
										<div class="cart_price">$<?= isset($cartTotal) ? $cartTotal : 0 ; ?></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="main_nav_menu ml-auto">
								<ul class="standard_dropdown main_nav_dropdown">
									<li><a href="<?php URL ?> index.php">Home<i class="fas fa-chevron-down"></i></a></li>
									<li><a href="<?php URL ?> products.php">All products<i class="fas fa-chevron-down"></i></a></li>
									<li><a href="<?php URL ?>cart.php">Cart<i class="fas fa-chevron-down"></i></a></li>
								</ul>
							</div>
