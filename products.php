...
<?php 
$pr=new Product;
$prods=$pr->select("products","id,name,price,img")->getAllRows();
// print_r($prod);
...
?>
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="<?php URL;?>uploads//shop_background.jpg"></div>
						...
						<div class="product_grid">
							...
							<div class="product_item">
								...
								<div class="product_image d-flex flex-column align-items-center justify-content-center">
									<img src="uploads/<?= $prod["img"]?>" alt=""> </div>
