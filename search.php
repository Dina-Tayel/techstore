...
$pr=new Product;
$prods=$pr->select("products","id,name,price,img")->search("name",$keyword)->getAllRows();
// print_r($prod);
?>
					...
					<div class="shop_content">
						...
						<div class="product_grid">
							...
							<div class="product_item">
								...
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="<?php URL ?> uploads/<?= $prod["img"] ?>" alt=""></div>
								<div class="product_content">
									<div class="product_price">$<?= $prod["price"] ?></div>
									<div class="product_name"><div><a href="<?php URL ?> product.php?id=<?= $prod["id"]?>" tabindex="0"><?= $prod['name'] ?></a></div></div>
								</div>
